    ...
    "example": {
        "inputs": {
            ...
            "polygonGeoJson": {
                "coordinates": [
                    [
                        [4582923.56687590200454, 3117421.271846642717719],
                        [4581124.431979617103934, 3115178.194573352113366],
                        [4584278.759395182132721, 3114862.761831795331091],
                        [4584278.759395182132721, 3114862.761831795331091],
                        [4582923.56687590200454, 3117421.271846642717719],
                    ]
                ],
...
class ZonalStatisticsTimeRasterstatsProcessor(BaseProcessor):  # noqa: D101
    ...
    def execute(self, data):  # noqa: D102
        ...
        if not url_exists(cog_dir_url):
            raise Exception("Cannot access provided URL: {}".format(cog_dir_url))
        if start_ts:
