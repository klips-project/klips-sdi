...
from .rasterstats_algorithms import get_location_info, get_location_info_time, get_zonal_stats, get_zonal_stats_time
...
def test_get_location_info_time():
    ...
    results = get_location_info_time(
        cog_dir_url, point, start_ts=datetime(2023, 1, 1, 10, tzinfo=pytz.UTC), end_ts=datetime(2023, 1, 1, 12, tzinfo=pytz.UTC), bands=[1, 2, 3])
...
def test_get_zonal_stats_time():
    ...
    polygon = shape(polygon_geojson)
    results = get_zonal_stats_time(cog_dir_url, polygon, start_ts=datetime(
        2023, 1, 1, 10, tzinfo=pytz.UTC), end_ts=datetime(2023, 1, 1, 12, tzinfo=pytz.UTC),
        bands=[1, 2, 3])
