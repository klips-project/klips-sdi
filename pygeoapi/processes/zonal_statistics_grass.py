...
PROCESS_METADATA = {
    ...
    "title": {"en": "Zonal statistics with GRASS", "de": "Zonale Statistik mit GRASS"},
    "description": {
                ...
                "features": [
                    {
                        ...
                        "geometry": {
                            "coordinates": [
                                [
                                    [13.7400130068375, 51.05477224322459],
                                    [13.7400130068375, 51.05720345861707],
                                    [13.736583726888085, 51.05720345861707],
                                    [13.736583726888085, 51.05477224322459],
                                    [13.7400130068375, 51.05477224322459],
                                ]
                            ],
                            "type": "Polygon",
                    ...
                    },
                    {
                        ...
                        "geometry": {
                            "coordinates": [
                                [
                                    [13.740371878140337, 51.052090240167644],
                                    [13.740371878140337, 51.050811847043576],
                                    [13.743043526473741, 51.050811847043576],
                                    [13.743043526473741, 51.052090240167644],
                                    [13.740371878140337, 51.052090240167644],
                                ]
                            ],
                            "type": "Polygon",
    ...
    def execute(self, data):  # noqa: D102
        ...
        try:
            result = generate_zonal_stats(
                rastermap=cog_url, geometries=geoms, crs=cog_crs
            )
        except Exception as e:
